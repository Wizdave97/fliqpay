    ...
    return (
        <div className='w-full flex flex-col relative py-4'>
            ...
            <div className='flex flex-row text-sharp-gray hover:text-header-blue cursor-pointer'>
                ...
                <span className='mx-4 w-24 font-medium capitalize text-xs md:text-sm'>{fee} {currency}</span>
                <span className='text-xs md:text-sm'>Transfer fee</span>
            </div>
            <div className='flex flex-row text-sharp-gray my-6 hover:text-header-blue cursor-pointer'>
                ...
                <span className='mx-4 min-w-24 font-medium capitalize text-xs md:text-sm'>{new Intl.NumberFormat().format(+amount.toFixed(2))} {currency}</span>
                <span className='text-xs md:text-sm'>Amount we'll convert</span>
            </div>
            <div className='flex flex-row text-sharp-gray hover:text-header-blue cursor-pointer'>
                <div className='w-20p h-20p z-10'>
                    <img src={Mul} className='w-full h-full' alt=''/>
                </div>
                <span className='mx-4 w-24 font-medium text-xs md:text-sm'>{rate}</span>
                <span className='text-xs md:text-sm'>Guaranteed rate (1hr)</span>
            </div>
        </div> 
    )
}
